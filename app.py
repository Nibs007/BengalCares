...
body = html.Div([
    dbc.Row([
            ...
            options=[{'label': i, 'value': i} for i in dd], style={'height': '60px','font-size':25,'fontWeight':'bold','font-family':"Arial","margin-bottom":'0.1px'},
            multi=False,
    ...
    html.Img(src='data:image/jpg;base64,{}'.format(encoded_image.decode()), 
            ...
            options=[{'label': i, 'value': i} for i in ll], style={'height': '60px','font-size':25,'fontWeight':'bold',"margin-bottom":'0.1px'},
            multi=False,
