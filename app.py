...
body = html.Div([
    dbc.Row([
               dbc.Col(html.Div(dbc.Alert("This app has been created to help people during these tough times. It collects publicly available data posted on modern digital channels. Leads shared may not be verified or accurate, or may lead to misleading content.", color="info",style={'height':'90px','font-size':18,'fontWeight': 'bold','font-family':"Arial"}))),
